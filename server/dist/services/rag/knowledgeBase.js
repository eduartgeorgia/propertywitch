...
exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE = void 0;
exports.getAllKnowledge = getAllKnowledge;
exports.getKnowledgeByCategory = getKnowledgeByCategory;
exports.getKnowledgeByTags = getKnowledgeByTags;
exports.getCategories = getCategories;
exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE = [
    // Buying Process
    {
...
function getAllKnowledge() {
    return exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE;
}
/**
 * Get knowledge by category
 */
function getKnowledgeByCategory(category) {
    return exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE.filter(doc => doc.category === category);
}
/**
 * Get knowledge by tags
 */
function getKnowledgeByTags(tags) {
    return exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE.filter(doc => tags.some(tag => doc.tags.includes(tag.toLowerCase())));
}
/**
 * Get all unique categories
 */
function getCategories() {
    return [...new Set(exports.PORTUGAL_REAL_ESTATE_KNOWLEDGE.map(doc => doc.category))];
}
