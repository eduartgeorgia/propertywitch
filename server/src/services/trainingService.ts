...
function buildPhotoUrl(photo: OLXListing["photos"][0]): string {
...
let currentTrainingProgress: TrainingProgress | null = null;
 ...
 */
export async function trainOnOLXListings(
  city: string,
  options: {
    categories?: string[];
    maxListings?: number;
    startOffset?: number; // Start from a specific offset to get new listings
